...
VALUES
	...
	('node.color.moveit', 'skyblue', 'N', NULL),
	('node.color.moveit-extract', 'lightskyblue', 'N', NULL),
	('node.color.moveit-index-pairing', 'dodgerblue', 'N', NULL),
	('node.color.moveit-index-search', 'dodgerblue', 'N', NULL),
	('node.color.moveit-transform', 'darkturquoise', 'N', NULL),
	('node.color.moveit-transform-patient', 'darkturquoise', 'N', NULL),
	...
	('node.color.raw-parquet', 'lightsalmon', 'N', NULL),
	...
	('node.color.supply-csv', 'goldenrod', 'N', NULL),
	...
	('node.color.work-parquet', 'mediumvioletred', 'N', NULL),
	...
	('node.type.supply-csv', 'db', 'N', NULL),
	('node.type.supply-druid', 'data', 'N', NULL),
	('node.type.surgical-supply-file', 'data', 'N', NULL),
	('node.type.work-parquet', 'data', 'N', NULL),
	('prop.app', 'source,prop/description,prop/date,prop/valid,prop/version', 'N', NULL),
	('prop.data', 'source,prop/description,prop/date,prop/valid', 'N', NULL),
	('prop.db', 'source,prop/description,prop/date,prop/valid', 'N', NULL),
	('prop.sortlist.app', 'date,valid,version', 'N', NULL),
	('prop.sortlist.data', 'abstracted_path,date,valid', 'N', NULL),
	('prop.sortlist.db', 'date,valid', 'N', NULL);
